          ...
          {services.map((service, index) => (
            <Reveal key={service.title} delay={index * 80}>
              <article className="card-premium surface-soft group h-full p-8">
                <span className="grid h-12 w-12 place-items-center rounded-2xl bg-secondary text-steel transition-colors duration-300 group-hover:bg-steel group-hover:text-accent-foreground">
